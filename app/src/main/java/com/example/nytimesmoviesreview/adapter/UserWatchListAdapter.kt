...
class UserWatchListAdapter(var context: Context):RecyclerView.Adapter<UserWatchListViewHolder>() {

    var moviesList= TinyDB(context).getListString("getWatchMovieList")

    private val layoutManager: LinearLayoutManager? = null
    override fun onCreateViewHolder(parent: ViewGroup, ViewType: Int): UserWatchListViewHolder {
        return UserWatchListViewHolder(parent)
    }


    override fun onBindViewHolder(holder: UserWatchListViewHolder, position: Int) {
...
class UserWatchListViewHolder(viewGroup: ViewGroup):RecyclerView.ViewHolder
